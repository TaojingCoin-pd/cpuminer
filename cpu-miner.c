...
static enum sha256_algos opt_algo = ALGO_OCEAN;
...
static void *miner_thread(void *userdata)
{
	...
	while (1) {
		...
		switch (opt_algo) {
        case ALGO_OCEAN:
			rc = scanhash_tjcoin(thr_id, work.data, work.target,
        ...
        applog(LOG_INFO, "this miner is for TjcoinV2-2.0,and this rc is %d", rc);
